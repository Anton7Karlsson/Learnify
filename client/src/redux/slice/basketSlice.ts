...
export const addBasketItemAsync = createAsyncThunk<Basket | undefined, {courseId: string}>('basket/addBasketItemAsync', async({courseId}, thunkAPI) => 
 {
    try {
...
export const basketSlice = createSlice({
    ...
    extraReducers: (builder) => { 
        ...
        builder.addCase(removeBasketItemAsync.fulfilled, (state, action) => {
            ...
            const itemIndex = state.basket?.items.findIndex((i) => i.courseId === courseId);
