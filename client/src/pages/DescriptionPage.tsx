      ...
      <div className="description-page">
        <div className="description-page__body">
          <div className="description-page__header">
            ...
            <div className="description-page__header__details">
                <div className="description-page__header__author">
                    Created by
                    <span className="description-page__header__author--name">
                        {course?.instructor}
                    </span>
                </div>
                <div className="description-page__header__language">
                    Language
                    <span className="description-page__header__language--name">
                        {course?.language}
                    </span>
                </div>
                <div className="description-page__header__updated">
                    Last updated
                    <span className="description-page__header__updated--date">
        ...
        <div className="description-page__sidebar">
            <div className="description-page__sidebar__box">
                <div className="description-page__sidebar__box--video">
                    <img alt="course__img" src={course?.image} width="100%" height="100%"/> 
                </div>
                <div className="description-page__sidebar__box__price">
                    <span className="description-page__sidebar__box__price__real">
                        {`$${course?.price}`}
                    </span>
                    <span className="description-page__sidebar__box__price__real__before">
                        $ 100
                    </span>
